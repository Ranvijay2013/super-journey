...
function add() {
	...
	background_imgTag.src = canvas_image;   // load image
...
function car1_up()
{
	...
	{
		car1_y = car1_y - 10;
		console.log("When up arrow is preesed, x = " + car1_x + "| y = " +car1_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_up()
{
	...
	{
		car2_y = car2_y - 10;
		console.log("When up arrow is preesed, x = " + car2_x + "| y = " +car2_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
